...
Click <span onclick="document.getElementById('imgAddress').style.visibility='visible';" style="font-weight: strong;">here</span> to see our address.

<img id="imgAddress" src="/assets/images/addresspic.png" style="visibility: hidden;">

click to <span onclick="document.getElementById('imgAddress').toggle();" style="font-weight: strong;">toggle</span>.
