...
Click <a onclick="document.getElementById('imgAddress').style.visibility='visible';" style="font-weight: strong;">here</a> to see our address.

<img id="imgAddress" src="/assets/images/addresspic.png" style="visibility: none;">
