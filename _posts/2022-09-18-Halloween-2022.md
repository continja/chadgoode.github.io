...
Click <a href="" onclick="document.getElementById('imgAddress').style.visibility='visible';">here</a> to see our address.

<img id="imgAddress" src="/assets/images/addresspic.png" style="visibility: hidden;">

click to <a href="" onclick="document.getElementById('imgAddress').toggle();">toggle</a>.
