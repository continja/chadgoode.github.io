...
Click <a href="" on_click="document.getElementById('imgAddress').style.visibility='visible';">here</a> to see our address.

<img id="imgAddress" src="/assets/addresspic.png" style="visibility-hidden;">

click to <a href="" on_click="document.getElementById('imgAddress').toggle();">toggle</a>.
